...
// Single Food
CREATE CONSTRAINT unique_single_food_id FOR (singleFood:SingleFood) REQUIRE singleFood.id IS UNIQUE
...
// Forged Food
CREATE CONSTRAINT unique_forged_food_id FOR (forgedFood:ForgedFood) REQUIRE forgedFood.id IS UNIQUE
